...
-8.219138984993535e-01, // 0
 6.597282339093540e-01, // 1
-1.150449660726971e+00, // 2
 1.442585980973359e+00, // 3
-8.244038036534984e-01, // 4
 2.969264972258691e-01, // 5
-7.026632802000936e-02, // 6
 1.129423484705970e-02, // 7
-1.244261433103052e-03, // 8
 9.246196073728235e-05, // 9
-4.419991477346595e-06, // 10
 1.223563700322787e-07, // 11
-1.485958970998293e-09 // 12
};
...
{
    d_AB =  4.744194281766978e+00; // A^(-1))
    k_AB =  7.608021884756502e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_rb_cl_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_rb_cl_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_rb_cl_cutoff(double* r)
#else
void mbnrg_2b_rb_cl_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

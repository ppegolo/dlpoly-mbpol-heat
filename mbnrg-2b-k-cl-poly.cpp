...
-1.156259802270209e+01, // 0
 3.793810578649600e+01, // 1
-4.472036541673768e+01, // 2
 1.158648077817201e+01, // 3
 2.578570164855594e+01, // 4
-3.414623480751490e+01, // 5
 2.146909639062950e+01, // 6
-8.400891287231918e+00, // 7
 2.180782562897024e+00, // 8
-3.774714216168932e-01, // 9
 4.200486384015590e-02, // 10
-2.720700648315153e-03, // 11
 7.791749744347341e-05 // 12
};
...
{
    d_AB =  6.999857718069624e+00; // A^(-1))
    k_AB =  3.124379656552765e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_k_cl_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_k_cl_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_k_cl_cutoff(double* r)
#else
void mbnrg_2b_k_cl_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

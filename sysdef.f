...
c     read bond atom indices and constraint bondlength
              ...
              elseif(record(starts(1):ends(1)).eq.'constr')then
...
c     read intramolecular dihedral potential parameters
              ...
              elseif(record(starts(1):ends(1)).eq.'dihedr')then
...
c     read intramolecular inversion potential parameters
              ...
              elseif(record(starts(1):ends(1)).eq.'invers')then
...
c            call strip(keyword,4)
            ...
            parpot(1)=dblstr(record(starts(4):ends(4)),80,idum)
            parpot(2)=dblstr(record(starts(5):ends(5)),80,idum)
            parpot(3)=dblstr(record(starts(6):ends(6)),80,idum)
            parpot(4)=dblstr(record(starts(7):ends(7)),80,idum)
            parpot(5)=dblstr(record(starts(8):ends(8)),80,idum)
            parpot(6)=dblstr(record(starts(9):ends(9)),80,idum)
            parpot(7)=dblstr(record(starts(10):ends(10)),80,idum)
            parpot(8)=dblstr(record(starts(11):ends(11)),80,idum)
            parpot(9)=dblstr(record(starts(12):ends(12)),80,idum)
            parpot(10)=dblstr(record(starts(13):ends(13)),80,idum)
            parpot(11)=dblstr(record(starts(14):ends(14)),80,idum)
            parpot(12)=dblstr(record(starts(15):ends(15)),80,idum)
            parpot(13)=dblstr(record(starts(16):ends(16)),80,idum)

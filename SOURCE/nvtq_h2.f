...
c
c     accumulator for constarint stress and virial
...
c     advance velocity by leapfrog
        ...
        gvxx(ig) = gvx1(jg) + tstep*(qn0(jg)/gmass(id) -(chit0)*
     x       0.5d0*(gvxx(ig)+gvx1(jg)))
        gvyy(ig) = gvy1(jg) + tstep*(qn1(jg)/gmass(id) -(chit0)*
     x       0.5d0*(gvyy(ig)+gvy1(jg)))
        gvzz(ig) = gvz1(jg) + tstep*(qn2(jg)/gmass(id) -(chit0)*

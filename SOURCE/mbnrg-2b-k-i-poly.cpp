...
-1.020571942428044e+01, // 0
 3.505489967515981e+01, // 1
-5.167213957246720e+01, // 2
 4.190360110791393e+01, // 3
-2.068443075630356e+01, // 4
 6.317260156214553e+00, // 5
-1.096688850177883e+00, // 6
 5.761428656374623e-02, // 7
 1.808213886743913e-02, // 8
-4.614353041905482e-03, // 9
 4.943345234974531e-04, // 10
-2.675980216534717e-05, // 11
 5.979105090720752e-07 // 12
...
{
    d_AB =  6.999335320725351e+00; // A^(-1))
    k_AB =  3.900780082713040e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_k_i_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_k_i_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_k_i_cutoff(double* r)
#else
void mbnrg_2b_k_i_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-4.424866597750128e+00, // 0
 2.476000500229916e+01, // 1
-6.035816858523958e+01, // 2
 7.903843817013097e+01, // 3
-6.288535993171843e+01, // 4
 3.236886288732015e+01, // 5
-1.113362342877858e+01, // 6
 2.598160159910502e+00, // 7
-4.109747905843154e-01, // 8
 4.323054315064355e-02, // 9
-2.886801645611196e-03, // 10
 1.104708148601384e-04, // 11
-1.841249354870042e-06 // 12
};
...
{
    d_AA =  5.473411669641624e+00; // A^(-1))
    k_AA =  5.270092152143715e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_cl_cl_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_cl_cl_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_cl_cl_cutoff(double* r)
#else
void mbnrg_2b_cl_cl_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

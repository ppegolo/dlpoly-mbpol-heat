...
-2.504557364810067e+00, // 0
-2.241646470960040e+00, // 1
 3.319950093614212e+00, // 2
-2.050471596581783e+00, // 3
 9.759785835037216e-01, // 4
-3.214438095639438e-01, // 5
 7.406436044571504e-02, // 6
-1.187383996115201e-02, // 7
 1.307390595580869e-03, // 8
-9.617752124805684e-05, // 9
 4.487026402896320e-06, // 10
-1.195085451426609e-07, // 11
 1.380400169891200e-09 // 12
};
...
{
    d_AB =  4.107414915051301e+00; // A^(-1))
    k_AB =  8.223388987235776e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_li_br_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_li_br_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_li_br_cutoff(double* r)
#else
void mbnrg_2b_li_br_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

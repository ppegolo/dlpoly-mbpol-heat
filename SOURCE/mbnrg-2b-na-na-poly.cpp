...
static const double the_poly[] = {
 3.684206139992523e-01, // 0
-1.271588866205780e+00, // 1
 1.592408700233083e+00, // 2
-5.438388733129734e-01, // 3
-7.459029875586448e-01, // 4
 1.083895612463108e+00, // 5
-6.895790108649004e-01, // 6
 2.663610406126178e-01, // 7
-6.697951031317191e-02, // 8
 1.100574427626954e-02, // 9
-1.131040776089945e-03, // 10
 6.463591945361788e-05, // 11
-1.483199090306578e-06 // 12
};
...
{
    d_AA =  6.999945411934039e+00; // A^(-1))
    k_AA =  3.127961439863758e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_na_na_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_na_na_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_na_na_cutoff(double* r)
#else
void mbnrg_2b_na_na_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

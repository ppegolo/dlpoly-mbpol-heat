     ...
     x  ckc,cks,clm,slm,stress,buffer)
...
#include "dl_params.inc"
      ...
      dimension chge(mxatms),cell(9),rcell(9),buffer(mxbuff)
      dimension xxx(mxatms),yyy(mxatms),zzz(mxatms)
      dimension fxx(mxatms),fyy(mxatms),fzz(mxatms)
      dimension ckc(mxatms),cks(mxatms),clm(mxatms),slm(mxatms)
      dimension elc(mxatms,0:1),els(mxatms,0:1)
      dimension emc(mxatms,0:kmaxb),ems(mxatms,0:kmaxb)
      dimension enc(mxatms,0:kmaxc),ens(mxatms,0:kmaxc)

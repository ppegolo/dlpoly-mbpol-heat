...
-3.684064823736875e+00, // 0
 7.794271042825895e+00, // 1
-7.263671799698599e-01, // 2
 9.562247277841297e-01, // 3
 9.478568196048103e-01, // 4
-9.517796814630045e-01, // 5
 3.733431392775548e-01, // 6
-8.300874033798319e-02, // 7
 1.141910266558363e-02, // 8
-9.882445204424336e-04, // 9
 5.233450068135551e-05, // 10
-1.548613524197224e-06, // 11
 1.961160410696709e-08 // 12
...
{
    d_AB =  3.704263083758495e+00; // A^(-1))
    k_AB =  9.283897930427744e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_cs_br_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_cs_br_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_cs_br_cutoff(double* r)
#else
void mbnrg_2b_cs_br_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-1.105737396060777e+01, // 0
 3.550585026128246e+01, // 1
-4.051727985097609e+01, // 2
 9.057124407611266e+00, // 3
 2.401315654775705e+01, // 4
-2.991498796080068e+01, // 5
 1.797099510800638e+01, // 6
-6.703095564986541e+00, // 7
 1.648601574400885e+00, // 8
-2.682202770922343e-01, // 9
 2.779261363424162e-02, // 10
-1.658954838911749e-03, // 11
 4.329622435888395e-05 // 12
};
...
{
    d_AB =  6.999991013187792e+00; // A^(-1))
    k_AB =  3.249342292740476e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_na_br_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_na_br_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_na_br_cutoff(double* r)
#else
void mbnrg_2b_na_br_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

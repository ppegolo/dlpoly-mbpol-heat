...
c     
c     first guess at thermostat and barostat variables and new cell
...
c     advance positions using leapfrog
          ...
          xxa = (xxx(i)+uxx(i))*0.5d0 - xcmo
          yya = (yyy(i)+uyy(i))*0.5d0 - ycmo
          zza = (zzz(i)+uzz(i))*0.5d0 - zcmo

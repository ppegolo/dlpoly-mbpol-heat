...
-4.798429034873866e+00, // 0
 1.239319085032645e+01, // 1
-7.442865441976753e+00, // 2
 1.276589372688322e+01, // 3
-9.210763164034290e+00, // 4
 4.616879379646644e+00, // 5
-1.680222682736505e+00, // 6
 4.328407778641012e-01, // 7
-7.615413385404368e-02, // 8
 8.828093564455032e-03, // 9
-6.401414571532400e-04, // 10
 2.620139579419476e-05, // 11
-4.608614418818893e-07 // 12
};
...
{
    d_AB =  3.807376890000581e+00; // A^(-1))
    k_AB =  8.720519501969789e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_cs_i_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_cs_i_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_cs_i_cutoff(double* r)
#else
void mbnrg_2b_cs_i_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-4.574703017287697e+00, // 0
-2.049113293778042e+00, // 1
 8.013312737238177e+00, // 2
-7.162600756411653e+00, // 3
 4.837744836747286e+00, // 4
-2.241514337164224e+00, // 5
 7.278984266154614e-01, // 6
-1.656625136994117e-01, // 7
 2.613298959162145e-02, // 8
-2.780151213053184e-03, // 9
 1.892010693812961e-04, // 10
-7.407525032004106e-06, // 11
 1.266183186901946e-07 // 12
};
...
{
    d_AB =  3.293275842613302e+00; // A^(-1))
    k_AB =  9.492942480540769e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_li_cl_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_li_cl_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_li_cl_cutoff(double* r)
#else
void mbnrg_2b_li_cl_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

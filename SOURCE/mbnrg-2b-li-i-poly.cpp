...
-1.822602366993976e+00, // 0
-5.662353242498144e-01, // 1
-2.348129274665349e+00, // 2
 4.071063913007997e+00, // 3
-3.013956516740143e+00, // 4
 1.415150811069033e+00, // 5
-4.451307420806700e-01, // 6
 9.615537791919743e-02, // 7
-1.426308782536779e-02, // 8
 1.422981126741224e-03, // 9
-9.087257032935709e-05, // 10
 3.341527499562170e-06, // 11
-5.361382789681271e-08 // 12
...
{
    d_AB =  4.816307594884659e+00; // A^(-1))
    k_AB =  6.324326553547865e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_li_i_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_li_i_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_li_i_cutoff(double* r)
#else
void mbnrg_2b_li_i_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-5.690195952234026e-01, // 0
-2.176768908474712e-01, // 1
 1.095720640874634e+00, // 2
-5.803335072286587e-01, // 3
 3.403441735918910e-01, // 4
-1.495384115636696e-01, // 5
 4.871700561837868e-02, // 6
-1.083883268797655e-02, // 7
 1.589402284918116e-03, // 8
-1.503735089034851e-04, // 9
 8.810048263262949e-06, // 10
-2.902113738123779e-07, // 11
 4.105128388944688e-09 // 12
...
{
    d_AB =  3.655849995310140e+00; // A^(-1))
    k_AB =  9.445627006372947e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_k_f_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_k_f_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_k_f_cutoff(double* r)
#else
void mbnrg_2b_k_f_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-7.187766179185551e-01, // 0
 3.727234333214253e-01, // 1
 1.395209796527431e+00, // 2
-1.103112729154851e+00, // 3
 6.581035299237010e-01, // 4
-2.218411019448498e-01, // 5
 4.637526639577842e-02, // 6
-6.362691553172100e-03, // 7
 5.841256161566508e-04, // 8
-3.553000384739459e-05, // 9
 1.373291891436860e-06, // 10
-3.052715856671196e-08, // 11
 2.970671452751541e-10 // 12
...
{
    d_AB =  3.671160490755223e+00; // A^(-1))
    k_AB =  1.009599155197563e+00; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_cs_f_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_cs_f_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_cs_f_cutoff(double* r)
#else
void mbnrg_2b_cs_f_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

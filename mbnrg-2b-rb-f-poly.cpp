...
-1.097779814360272e+00, // 0
 1.695767747177081e+00, // 1
-6.813233371774274e-01, // 2
 2.187622016347567e+00, // 3
-1.943035020522820e+00, // 4
 1.091172683217837e+00, // 5
-3.855951844211648e-01, // 6
 8.809582702596858e-02, // 7
-1.323177785523718e-02, // 8
 1.298513820356168e-03, // 9
-8.015359165396594e-05, // 10
 2.824435453242480e-06, // 11
-4.332484950806145e-08 // 12
...
{
    d_AB =  3.358834521560037e+00; // A^(-1))
    k_AB =  1.010925715564634e+00; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_rb_f_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_rb_f_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_rb_f_cutoff(double* r)
#else
void mbnrg_2b_rb_f_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

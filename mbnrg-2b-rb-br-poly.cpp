...
-1.789901491156238e+00, // 0
 7.075200506421171e+00, // 1
-1.445488636498269e+01, // 2
 1.556890470190560e+01, // 3
-1.020390660489646e+01, // 4
 4.424628939761783e+00, // 5
-1.308915266767108e+00, // 6
 2.679233063027696e-01, // 7
-3.779722792531835e-02, // 8
 3.594430159172196e-03, // 9
-2.193584584362199e-04, // 10
 7.736795632792228e-06, // 11
-1.196258754194961e-07 // 12
};
...
{
    d_AB =  5.621000976150929e+00; // A^(-1))
    k_AB =  5.505135512274120e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_rb_br_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_rb_br_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_rb_br_cutoff(double* r)
#else
void mbnrg_2b_rb_br_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

...
-1.344130412230764e+01, // 0
 4.245453374852288e+01, // 1
-4.764855058195855e+01, // 2
 9.705054328569334e+00, // 3
 2.891094804458345e+01, // 4
-3.518805283139952e+01, // 5
 2.095268526042462e+01, // 6
-7.790262831212044e+00, // 7
 1.918633397244354e+00, // 8
-3.140675989532776e-01, // 9
 3.291762176069805e-02, // 10
-2.000004552932378e-03, // 11
 5.353117280916910e-05 // 12
};
...
{
    d_AB =  6.999989957509445e+00; // A^(-1))
    k_AB =  3.337444679449091e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_na_i_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_na_i_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_na_i_cutoff(double* r)
#else
void mbnrg_2b_na_i_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}

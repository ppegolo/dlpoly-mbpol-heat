...
-5.494635171210952e+01, // 0
 1.458722442222962e+02, // 1
-7.928422385841775e+01, // 2
-8.502512802899201e+01, // 3
 5.735958185703778e+01, // 4
 7.384853421756978e+01, // 5
-5.193689073605903e+01, // 6
-5.518347852955046e+01, // 7
 8.332185033952945e+01, // 8
-4.537505128527047e+01, // 9
 1.289888472509191e+01, // 10
-1.913961647756901e+00, // 11
 1.174849710739308e-01 // 12
};
...
{
    d_AA =  6.999974503730231e+00; // A^(-1))
    k_AA =  2.516315740066213e-01; // A^(-1))   
...
#ifdef BGQ
void mbnrg_2b_i_i_poly(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#else
void mbnrg_2b_i_i_poly_(const double* w, const double* x ,
                    double* E, double* g1, double* g2)
#endif
{
...
#ifdef BGQ
void mbnrg_2b_i_i_cutoff(double* r)
#else
void mbnrg_2b_i_i_cutoff_(double* r)
#endif
{
    *r = the_model.m_r2f;
}
